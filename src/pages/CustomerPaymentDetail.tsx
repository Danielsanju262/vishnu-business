    ...
    return (
        <>
            <div className="min-h-screen bg-background text-foreground px-3 md:px-4 pb-32 w-full md:max-w-2xl md:mx-auto">
                ...
                {/* Balance Card */}
                <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 dark:from-emerald-600 dark:to-emerald-700 rounded-2xl p-6 mb-6 text-white shadow-xl">
                                                ...
                                                <div className="flex items-center gap-2 mb-0">
                                                    ...
                                                    {!isSelectionMode && isEditable && (
                                                        <button
                                                            ...
                                                            className="p-2 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-1"

...
export default function Customers() {
    ...
    const [isAdding, setIsAdding] = useHistorySyncedState(false, 'customersAdding');
    const [isSelectionMode, setIsSelectionMode] = useHistorySyncedState(false, 'customersSelection');

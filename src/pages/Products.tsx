...
export default function Products() {
    ...
    const [isAdding, setIsAdding] = useHistorySyncedState(false, 'productsAdding');
    const [isSelectionMode, setIsSelectionMode] = useHistorySyncedState(false, 'productsSelection');

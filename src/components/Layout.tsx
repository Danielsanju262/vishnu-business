...
export default function Layout() {
    ...
    const navItems = [
        ...
        // { path: "/reports", icon: BarChart3, label: "Reports" }, // Reports is usually accessed via dashboard stats, but we can add it if needed. Let's keep it simple for now.
                        ...
                        return (
                            ...
                            >
                                <div className={cn(
                                    ...
                                    isActive ? "bg-primary/10 opacity-100 scale-100" : "group-hover:bg-accent group-hover:opacity-100 group-hover:scale-75"
                                )} />
                                <Icon
                                    size={24}
                                    className={cn("relative z-10 transition-transform duration-300", isActive ? "scale-110" : "group-hover:scale-105")}
